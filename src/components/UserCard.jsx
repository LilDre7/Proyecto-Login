      ...
      <section className="section__info p-2 mt-[-2rem] shadow-md shadow-slate-900 rounded-xl min-h-[240px]">
        ...
        <div className="gap-3 mt-3 flex justify-end items-center shadow-inner shadow-slate-950 rounded-xl ">
          <button
            ...
            className="text-[2rem] text-blue-500 hover:text-red-500 transition-duration-500"
          >
          ...
          <button
            onClick={() => {
              Swal({
                title: "¿Estás seguro?",
                text: "Esto eliminará permanentemente al usuario seleccionado",
                icon: "warning",
            ...
            className="text-[2rem] text-red-500 hover:text-blue-500 transition-duration-500"
          >
