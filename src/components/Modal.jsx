    ...
    >
      ...
      >
        ...
        <div className="flex flex-col w-full gap-1">
          ...
          <input
            className="border-[1px] rounded-sm p-2 placeholder:text-red-400 placeholder:text-xs"
            id="first_name"
            type="text"
        ...
        <div className="flex flex-col w-full gap-1">
          ...
          />
          <span className="text-red-500 p-1 text-center ">
        ...
        <div className="flex flex-col w-full gap-1">
          ...
          />
          <span className="text-red-500 p-2 max-w-[50%] ">
